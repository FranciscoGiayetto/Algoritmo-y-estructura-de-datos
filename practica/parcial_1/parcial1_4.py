...
print(f'Ejercicio 1: multiplo de 3: {multiplos_3} \n\t multiplo de 7: {multiplos_7} \n\t multiplos de otros: {multiplos_no_3_7}')
print(f'Ejercicio 2: menor numero: {menor_numero} -- comprobacion {comprobacion(min(lista_menores), menor_numero)}')
print(f'Ejercicio 3: promedio: {promedio} -- comprobacion {comprobacion(int(mean(lista_promedio)), promedio)}')
print(f'Ejercicio 4: porcentaje: {porcentaje}')
print(f'Ejercicio 5: suma: {suma_numeros} -- comprobacion {comprobacion(sum(lista_suma), suma_numeros)}')